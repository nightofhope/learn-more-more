...
class cousesubsci extends StatelessWidget {
  const cousesubsci({Key? key}) : super(key: key);
  ...
  Container buildButton1cousesub(BuildContext context) {
    return Container(
        ...
        child: FlatButton(
          ...
          onPressed: () => {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => sci1()))
          },
        ),
  ...
  Container buildButton2cousesub(BuildContext context) {
    return Container(
        ...
        child: FlatButton(
          ...
          onPressed: () => {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => sci2()))
          },
        ),
        margin: EdgeInsets.only(top: 16),
        padding: EdgeInsets.all(12));
  ...
  Container buildButton3cousesub(BuildContext context) {
    return Container(
        ...
        child: FlatButton(
          ...
          onPressed: () => {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => sci3()))
          },
        ),
        margin: EdgeInsets.only(top: 16),
        padding: EdgeInsets.all(12));
        ...
        child: FlatButton(
          ...
          onPressed: () => {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => cousesub2sci4()))
          },
        ),
        margin: EdgeInsets.only(top: 16),
        padding: EdgeInsets.all(12));
  ...
  Container buildButton5cousesub(BuildContext context) {
    return Container(
        ...
        child: FlatButton(
          ...
          onPressed: () => {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => cousesub2sci5()))
          },
        ),
        margin: EdgeInsets.only(top: 16),
        padding: EdgeInsets.all(12));
  ...
  Container buildButton6cousesub(BuildContext context) {
    return Container(
        ...
        child: FlatButton(
          ...
          onPressed: () => {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => cousesub2sci6()))
          },
        ),
        margin: EdgeInsets.only(top: 16),
        padding: EdgeInsets.all(12));
